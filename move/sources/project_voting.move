module aptos_vibes::project_voting {
    use std::signer;
    ...
    /// Get vote counts for a project (upvotes, downvotes)
    #[view]
    ...
    /// Get the net vibe score for a project (upvotes - downvotes)
    /// Returns (net_score, is_positive) where is_positive=true means upvotes > downvotes
    #[view]
    ...
    /// Check if a project exists in the voting system
    #[view]
